...
TEST_CONFIG_HINTS={
    "string_config_direct": {
        "data": "this is string_config_direct"
    },
    ...
    "int_config_no_default_not_marked_number": {
        "env": "PYOBAS_TEST_CONFIGURATION_INT_CONFIG_NO_DEFAULT",
        "file_path": ["pyobas_test_configuration", "int_config_no_default_not_marked_number"],
    },
...
class TestConfiguration(unittest.TestCase):
    ...
    @patch.dict(os.environ, values={"PYOBAS_TEST_CONFIGURATION_STRING_CONFIG_NO_DEFAULT": "actual value"}, clear=True)
    def test_when_string_config_has_no_default_when_key_is_in_env_return_env_value(self):
        config_obj = Configuration(
            config_hints=TEST_CONFIG_HINTS,
        )
    ...
    @patch.dict(os.environ, values={"PYOBAS_TEST_CONFIGURATION_STRING_CONFIG_WITH_DEFAULT": "actual value"}, clear=True)
    ...
    def test_when_key_is_in_both_env_and_file_return_env_value(self):
        config_obj = Configuration(
            config_hints=TEST_CONFIG_HINTS,
            config_values={"pyobas_test_configuration": {
    ...
    def test_when_string_config_has_no_default_when_key_is_in_file_return_file_value(self):
        config_obj = Configuration(
            config_hints=TEST_CONFIG_HINTS,
            config_values={"pyobas_test_configuration": {
                "string_config_no_default": "another value"
    ...
    @patch.dict(os.environ, values={"PYOBAS_TEST_CONFIGURATION_INT_CONFIG_NO_DEFAULT": "1234"}, clear=True)
    ...
    def test_when_int_config_has_no_default_when_key_is_passed_as_int_return_int_value(self):
        config_obj = Configuration(
            config_hints=TEST_CONFIG_HINTS,
            config_values={"pyobas_test_configuration": {
                "int_config_no_default": 456_123
            }}
        )
    ...
    def test_when_int_config_has_no_default_when_key_is_passed_as_int_when_config_is_not_marked_as_number_return_int_value(self):
        config_obj = Configuration(
            config_hints=TEST_CONFIG_HINTS,
            config_values={"pyobas_test_configuration": {
    ...
    @patch.dict(os.environ, values={"PYOBAS_TEST_CONFIGURATION_STRING_CONFIG_NO_DEFAULT": "yes"}, clear=True)
    def test_when_string_config_has_no_default_when_string_is_boolean_when_key_is_in_env_return_env_value(self):
        config_obj = Configuration(
            config_hints=TEST_CONFIG_HINTS,
        )
